...
![](http://1.0.0.137:3033/ovchinnikov_ii/git-man/src/master/pics/a1.png?raw=true "manager")

Репозиторий должен появиться в списке удалённых репозиториев пользователя<sup id="ft3">[3](#usrep)</sup>

![](http://1.0.0.137:3033/ovchinnikov_ii/git-man/src/master/pics/a2.png?raw=true "clone")
