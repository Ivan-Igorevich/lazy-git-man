...
Необходимость в обновлении форков может возникать в случае когда основной репозиторий был обновлён, и внесённые изменения необходимо применить также в созданном форке.
